...
pre = torch.randn(5, 15, 100)
pre_length = torch.tensor([8, 9, 10, 12, 15])
target = torch.arange(0, 50).view(5, 10)
target_length = torch.tensor([10, 10, 10, 10, 9])

loss = axe_loss(pre, pre_length, target, target_length, blank_index=0, delta=2.0)
print(loss)
